...
def live_fatigue_local(config_path: str, SN_curve: Dict[str,Any]) -> FatigueAnalysis | None:
    """
    ...
    try:
        while True:
            ...
            if first:
                ...
                first = False
            fig_ax4 = plot_eol_rul(fatigue_object.result, inital_time, current_time,
                                   output_time_unit = "hrs",damage_sum = DAMAGE_SUM,
                                   x_length = 50, fig_ax = fig_ax4)
...
def live_fatigue_remote(config_path: str, SN_curve: Dict[str,Any]) -> FatigueAnalysis | None:
    """
    Apply continuously fatigue calculation to estimated stress and estimated displacements.
    Args:
        config_path (str): path to config file
...
def plot_rainflow_counting(config_path: str, SN_curve: Dict[str,Any]) -> FatigueAnalysis | None:
    """
    Apply a single fatigue calculation to estimated stress and estimated displacements.
    Args:
        config_path (str): path to config file
