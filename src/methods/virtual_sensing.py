...
def live_virtual_sensing(config_path, number_of_minutes):
    """
    ...
    try:
        while True:
            disp, acc = live_virtual_sensing(number_of_minutes, aligner, data_client, fs)
...
def virtual_sensing_and_plot(config_path, number_of_minutes):
    """
    Estimate displacement with virtual sensing 
    Args:
        config_path (str): Path to config file
