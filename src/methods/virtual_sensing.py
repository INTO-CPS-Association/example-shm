...
def virtual_sensing(number_of_samples, aligner, data_client, fs):
    ...
    try:
        ...
        try:
            ...
            return disp, acc, model_parameters
...
def live_virtual_sensing(config_path):
    ...
    try:
        while True:
            disp, _, _ = virtual_sensing(mqtt_config['SamplesToCollect'], aligner, data_client, fs)
...
def virtual_sensing_and_plot(config_path):
    ...
    disp, acc, _ = virtual_sensing(number_of_samples, aligner, data_client, fs)
