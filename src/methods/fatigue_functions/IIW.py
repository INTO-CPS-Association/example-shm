    ...
    if stress_type.lower() == "sigma":
            ...
            try: #Slope override
                ...
                if FAT >= 70:
                    ...
                    try:
                        ...
                        raise KeyError("m1 must be supplied in the case of FAT 50, 45, 40") from exc
                else:
                    m1 = 3
        else: #steel
            try: #Slope override
                ...
                if FAT > 125:
                    ...
                    try:
                        ...
                        raise KeyError("m1 must be supplied in the case of FAT 125") from exc
                else:
                    m1 = 3
        try: #Slope override
            m2 = kwargs["m2"]
            ...
            if signal_type == "CA": #IIW 4.2.2
                ...
                raise KeyError('Unknown signal type, use eg. signal_type = "VA" or "CA"') from exc
        ...
        try: #Slope override
            ...
            if signal_type == "CA": #IIW 4.2.2
                ...
                raise ValueError('Unknown signal type, use eg. signal_type = "VA" or "CA"') from exc
