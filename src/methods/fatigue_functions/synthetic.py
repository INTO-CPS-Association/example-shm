...
def synthetic_sn(material: str, R_m: float, SF: Optional[float] = 1) -> dict[str, Any]:
    ...
    material_table = {'rolled_steel': [0.45, 0],
                      'cast_iron': [0.27, 85],
                      'ductile_cast_iron': [0.27, 100],
                      'laminar_cast_iron': [0.27, 110],
                      'Mallable_cast_iron': [0.39, 0]} #dictionary of material SN-curve parameters
