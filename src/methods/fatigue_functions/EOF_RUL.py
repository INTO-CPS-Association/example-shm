...
def eof_rul(result: dict[str, Any], time_passed: datetime,
            output_time_unit: Optional[str] = "hrs",
            damage_sum: Optional[float] = 1) -> tuple[float,float]:
