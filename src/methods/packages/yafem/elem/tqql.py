...
from methods.packages.yafem.elem.tqql_func import *
...
#%% Plot 3d elements
    def plot(self, ax, x=None, y=None, z=None, color='cyan'):
        ...
        triangles = np.array([[0, 3, 5],
                              [3, 1, 4],
                              [5, 4, 2],
                              [3, 4, 5],
                            ])

        # Plot triangular surface without edges
        ax.plot_trisurf(x, y, z, triangles=triangles, color='cyan', alpha=0.5)
        ...
        # Use Line3DCollection for more efficient plotting of many edges
        line_collection = Line3DCollection(lines, color='black', linewidth=0.5)
