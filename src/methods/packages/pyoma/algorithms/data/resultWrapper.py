...
class SSIResult(BaseResult):
    ...
    Ufx_list : numpy.NDArray, optional
        Ufx vectors of all modes
    ...
    Fn_poles_cov: npt.NDArray[np.float64] | None = None
    Xi_poles_cov: npt.NDArray[np.float64] | None = None
    Phi_poles_cov: npt.NDArray[np.float64] | None = None
    Ufx_list: npt.NDArray[np.float64] | None = None
